...
export default function Techs() {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            {/* Technologies Grid */}
            <div className="backdrop-blur-lg rounded-3x pt-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {/* React Technology */}
                    <div 
                        className="group hover:border-purple-400 bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-200 p-6 hover:bg-white/80 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2"
                    >
                        ...
                        <h3 className="text-xl font-semibold text-gray-800 text-center mb-3 group-hover:text-purple-700 transition-colors duration-300">
                            {reactTech.name}
                        </h3>
                    ...
                    <div 
                        className="group bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-200 p-6 hover:bg-white/80 hover:border-purple-400 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2"
