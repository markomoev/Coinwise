...
export default function Features() {
    return(     
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mt-8'>
            {/* Feature 1 */}
            <div className='bg-white/70 backdrop-blur-lg rounded-xl border border-gray-200 p-6 hover:bg-white/90 hover:shadow-lg hover:border-purple-400 transition-all duration-300'>
