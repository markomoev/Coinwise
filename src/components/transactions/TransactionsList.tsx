...
export default function TransactionsList({AddTransaction, transactions}: Props) {
    ...
    return(
                <div className="bg-gradient-to-b from-white to-gray-50/50 shadow-lg border border-black/10 rounded-2xl flex flex-col transition-all duration-300 hover:shadow-xl h-[calc(100vh-4.5rem)]">
            {/* header*/}
