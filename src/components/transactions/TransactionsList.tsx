    ...
    return(
        <div className = 'bg-white shadow-lg border border-black/10 rounded-2xl flex flex-col gap-10'>
            <div className = 'flex flex-row justify-between mt-5 pl-[1%] pr-[1%] pb-3'>
                ...
                <button className = 'font-semibold border border-black/10 rounded-2xl hover:shadow-lg cursor-pointer pr-3 pl-3 pt-1 pb-1 bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent'>
                    Add new
                </button>
            </div>
