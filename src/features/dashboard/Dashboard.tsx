        ...
        <div className="w-full h-auto">
            <div className = 'w-full flex flex-row gap-20'>
                ...
                <div className="md:mr-10 md:mt-0 mt-10 flex flex-1 flex-col gap-10 w-full h-auto items-center">
                        ...
                        <div className="bg-white/95 border border-black/10 backdrop-blur-xl shadow-lg p-6 rounded-2xl">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">Overview of your financial health and recent activity</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-[95%] max-w-6xl space-y-6">
                        {/* Total Balance Card */}
                        <TotalCard
                    ...
                    <div className="w-[95%] max-w-6xl">
                        <div className="bg-white/95 border border-black/10 backdrop-blur-xl shadow-lg p-8 rounded-2xl text-center">
                            ...
                            <p className="text-gray-600">Interactive charts and detailed financial analytics will be available here</p>
                        </div>
                    </div>
                </div>
